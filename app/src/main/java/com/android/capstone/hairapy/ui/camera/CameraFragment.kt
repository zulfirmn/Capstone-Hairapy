...
import com.android.capstone.hairapy.data.model.ImageResult
import com.android.capstone.hairapy.data.utils.createFile
import com.android.capstone.hairapy.data.utils.rotateBitmap
import com.android.capstone.hairapy.data.utils.toBitmap
import com.android.capstone.hairapy.data.utils.toFile
import com.android.capstone.hairapy.databinding.FragmentCameraBinding
...
class CameraFragment: Fragment() {
    ...
    private fun movesToUpload(imageResult: ImageResult) {
        val toUploads = CameraFragmentDirections.actionCameraFragmentToResultFragment(imageResult)
        findNavController().navigate(toUploads)
    }
